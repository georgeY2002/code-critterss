...
@Service
public class WebScrapingStacksService {

    // Add your DeepL API key here
    private static final String DEEPL_API_KEY = "44c6646f-25ac-4abc-ab50-58b28d62aaef:fx";

    // Method to scrape content from the W3Schools Stacks page
    public String scrapeW3SchoolsStacksPage() throws IOException {
        String url = "https://www.w3schools.com/dsa/dsa_data_stacks.php";
    ...
    // Method to convert HTML content to a PDF and return as a byte array
    ...
    // Method to scrape the page and return content in the specified language
    public String scrapeContentInLanguage(String lang) throws IOException {
        String htmlContent = scrapeW3SchoolsStacksPage();
        if (htmlContent.equals("Content not available.")) {
            throw new IOException("Content not available.");
        }

        // Check if the language is supported
        List<String> supportedLanguages = Arrays.asList("EN", "DE", "FR", "ES", "PT", "IT", "NL", "PL", "RU", "JA", "ZH", "AR");
    ...
    // Method to scrape the page and generate a PDF in the specified language
    public byte[] scrapeAndGeneratePdf(String lang) throws IOException {
        String htmlContent = scrapeContentInLanguage(lang);
